...
from egnas.gnn import GraphNet as BaseNet
from egnas.search_space import act_map
...
class GraphNet(BaseNet):
    ...
    def build_hidden_layers(self, actions, batch_normal, drop_out, layer_nums, num_feat, num_label, state_num=6):
        ...
        # in_channels = out_channels * head_num
        # out_channels = self.num_label
        # self.linear_classifier = torch.nn.Linear(in_channels, out_channels * head_num)
